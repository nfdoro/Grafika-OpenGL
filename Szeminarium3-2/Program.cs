...
namespace GrafikaSzeminarium
{
    internal class Program
    {
        ...
        private static string[] colors = { "blue", "green", "red", "yellow", "magenta", "cyan" };
        private static int colorIndex = 0;

        private static Vector4[] colorValues = new Vector4[]
        {
        ...
        private static unsafe void GraphicWindow_Render(double deltaTime)
        {
            ...
            ImGuiNET.ImGui.Begin("TopFaceColor", ImGuiNET.ImGuiWindowFlags.AlwaysAutoResize | ImGuiNET.ImGuiWindowFlags.NoCollapse);
            ImGuiNET.ImGui.Combo("", ref colorIndex, colors, colors.Length);
            {
                Vector4 selectedColor = colorValues[colorIndex];
                float[] topFaceColor = new float[]
                {
                    selectedColor.X,
                    selectedColor.Y,
                    selectedColor.Z,
                ...
                cube.Dispose();
                cube = ModelObjectDescriptor.CreateCube(Gl, topFaceColor);
            }
            ImGuiNET.ImGui.End();
